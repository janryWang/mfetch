...
var getOptions = function getOptions(url, options) {
    if ((0, _lang.isStr)(url) || url instanceof URL) {
...
var http = function http(args, _options) {
    ...
    return pluginService.post("request", pluginService.post("afterOption", pluginService.post("subOption", pluginService.post("option", pluginService.post("beforeOption", _options2)))));
};
